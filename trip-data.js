  ...
  days: [
    {
      ...
      notesHe:["היום הזה חידד את סגנון הטיול: פחות לרדוף אחרי רשימה, יותר מקום יפה + אוכל טוב + דרך יפה + זמן ליהנות מהמלון.","המלון עצמו הוא חלק מהחוויה ולא רק מקום לישון."],
      notesRu:["Этот день задал стиль поездки: меньше гонки за списком, больше красивых мест, хорошей еды, живописных дорог и времени в отеле.","Отель — часть впечатлений, а не просто место для сна."],
